...
ap.add_argument("-t", "--output", required=False,
...
path_train = '/home/jetbot/object detector/pyimage_custom_dlib/ibug_300W_large_face_landmark_dataset/labels_ibug_300W_train.xml'
path_test = '/home/jetbot/object detector/pyimage_custom_dlib/ibug_300W_large_face_landmark_dataset/labels_ibug_300W_test.xml'
path_train_eyes = '/home/jetbot/object detector/pyimage_custom_dlib/ibug_300W_large_face_landmark_dataset/labels_ibug_300W_train_eyes.xml'
path_test_eyes = '/home/jetbot/object detector/pyimage_custom_dlib/ibug_300W_large_face_landmark_dataset/labels_ibug_300W_test_eyes.xml'

# load the contents of the original XML file and open the output file
# for writing
print("[INFO] parsing data split XML file...")
rows = open(path_test).read().strip().split("\n")
output = open(path_test_eyes, "w")
