...
path = '/home/jetbot/object detector/pyimage_custom_dlib/ibug_300W_large_face_landmark_dataset/labels_ibug_300W_train_eyes.xml'
...
dlib.train_shape_predictor(path, 'eye_detector.dat', options)